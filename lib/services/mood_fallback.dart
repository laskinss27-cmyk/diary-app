...
class MoodFallback {
  ...
  static const _crisis = [
    ...
    // Self-harm — все формы глагола «резать» + «царапать»
    'перерезать вен', 'вскрою вен', 'вскрыть вен', 'вскрыл вен', 'вскрыла вен',
    'вскрываю вен', 'вскрываюсь',
    'режу вен', 'режу себ', 'режу руки', 'режу кожу',
    'резать вен', 'резать себ',
    'порезал себ', 'порезала себ', 'порежу себ',
    'порезы на', 'порез на руке', 'порез на запяст',
    'царапаю себ', 'царапать себ', 'царапины на',
    'делаю себе больно', 'делать себе больно',
    'причиняю себе боль', 'причинять себе боль',
    'самоповреждение', 'селфхарм',
    // Pills / overdose
    'наглотаться таблеток', 'наглотаюсь таблеток', 'наглоталась таблеток',
    'наглотался таблеток', 'выпить таблеток', 'передозировк',
    // Heights / jumping
    ...
    'нет смысла существовать', 'хочу исчезнуть навсегда',
    // Burden
    'никому не нужен', 'никому не нужна', 'всем будет лучше без меня',
    'без меня всем будет лучше', 'мир без меня', 'я обуза', 'я бремя', 'я лишний',
    'устал жить', 'устала жить',
    // Direct intent / overwhelm
    'я в кризисе', 'у меня кризис', 'мне очень плохо', 'мне совсем плохо',
    'не справля', 'не выдерживаю', 'не вытяну',
  ];
  static const _crisisWords = {
    ...
    'режу': 'самоповреждение', 'порез': 'самоповреждение',
    'царап': 'самоповреждение', 'делаю себе больно': 'самоповреждение',
    'смысл': 'потеря смысла', 'не нужен': 'ощущение ненужности',
    'бессмысленн': 'экзистенциальный кризис', 'устал жить': 'истощение',
    'обуза': 'ощущение бремени', 'не справля': 'истощение',
  };
